...
if __name__ == "__main__":
    ...
    model = LightningModule(ConvNet(), args.opt)
    ...
    train_dl = DataLoader(trainset, batch_size=128, num_workers=8)
    val_dl, test_dl = DataLoader(valset, batch_size=128, num_workers=8), DataLoader(testset, batch_size=128, num_workers=8)
